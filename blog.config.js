const BLOG = {
  ...
  craftConfigShareUrl: 'https://www.craft.do/s/SCJBPj9t3tAWoR', // The link to share your craft config
  notesNav: {
    index: 'Home',
    blog: 'My Blog',
    contact: 'Contact'
  ...
  notesLink: {
    index: '/',
    blog: 'https://archive.pieris05.com',
    contact: 'https://pieris05.com/#contact'
  },
  socialLink: {
    twitter: 'https://twitter.com/JiaxiongYu',
    github: 'https://github.com/THU-Pieris',
    telegram: 'https://t.me/pieris_bot'
  },
  seo: {
